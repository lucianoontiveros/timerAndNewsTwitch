...
const Banner = (props) => {
  return (
    ...
    <div className="cardImg flex flex-col items-center bg-purple-900 rounded-lg shadow md:flex-row ">
      ...
      <div id="cuerpoAlerta" className="flex flex-col justify-between p-4 leading-normal">
        ...
        <h5 className="mb-3 text-center  text-blue-300 text-2xl" > {props.aviso}</h5 >
      </div >
    </div >
